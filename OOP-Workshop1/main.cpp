...
/////////////////////////////////////////////
#include "Bill.h"
//#include <cstddef> //this is here because of NULL
...
/*
//Questions:
1. nullptr: error: use of undeclared identifier 'nullptr' --OK
2.formatting: only the first line is being formatted
3. check if my Item::isValid is good
